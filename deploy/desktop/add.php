...
<div class="row-fluid">
  <div class="span4">
    <label for="name">Business Name</label><input type="text" name="name" />
    <label for="logo">Upload Logo</label><input type="file" name="logo" />
    <label for="address1">Address Line 1</label><input type="text" name="address1" />
    <label for="address2">Address Line 2</label><input type="text" name="address2" />
  ...
  <div class="span8">
    ...
    <p style="margin: 10px 0;"><input type="checkbox" name="terms" style="margin: 0 6px 0 0;" /> <strong>I agree to the terms and conditions above.</strong></p>
